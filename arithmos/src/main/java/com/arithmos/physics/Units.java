...
public final class Units {
    ...
    public static double convertInto(final double number, final Units.IndexNotation notation){
        return number * notation.BASE_10;
    }
    public static String getFormat(final double number, final Units.IndexNotation notation){
