...
public final class NativeImageLoader {
    ...
    public enum NativeImage {
        LINUX_x86_x64("native/Linux/linux-x86-x64/libArithmosNatives.so"),
        LINUX_x86_x86("native/Linux/linux-x86-x86/libArithmosNatives.so"),
        MAC_x86_x64("native/OSX/mac-x86-x64/libArithmosNatives.dylb"),
        WIN_x86_x64("native/Windows/win-x86-x64/libArithmosNatives.dll");
    ...
    private static void extractImage(final NativeImage image) {
        ...
        try {
            ...
            final FileOutputStream fos = new FileOutputStream(workingDirectory + "/libArithmosNatives.so");  
            int result = 0;
            ...
            nativeImageIS.close();
            fos.close();
            System.load(workingDirectory + "/libArithmosNatives.so");
